                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="bg-white pinside30">
                        <div class="row align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                <h1 class="page-title">Loaning Project
                                </h1>
                            </div>
                    ...
                    <div class="sub-nav" id="sub-nav">
                        <ul class="nav nav-justified">
                            ...
                            <li class="nav-item">
                                <a href="Loancalc.php" target="_blank"class="nav-link">Loan-Calculator</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <div class="post-holder">
                                            <div class="post-block mb40">
                                                <div class="post-img mb30">
                                                    <a href="#" class="imghover"><img src="images/loaning-project (1) (1).jpg" alt="Sama Investments" class="img-fluid"></a>
                                                </div> 
                                                <div class="bg-white">
